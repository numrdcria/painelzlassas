...
def create_support_entry(client: Client | None = None) -> None:
    ...
    if not contact_name or not contact_phone or not title or not description:
        flash("Informe nome, telefone, titulo e descricao do atendimento.", "danger")
        return
    ...
    attendance = Attendance(
        ...
        service_status=service_status if service_status in SUPPORT_STATUSES else "aberto",
